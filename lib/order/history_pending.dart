              ...
              children: [
                ...
                Row(
                  children: const [
                    Text("Status : ", style: TextStyle(color: Colors.black, fontFamily: 'Shanti', fontSize: 16,)),
                        Text("Pending", style: TextStyle(color: Colors.red, fontFamily: 'Shanti', fontSize: 16,)),
                  ],
                ),
                const SizedBox(
                  height: 7,
                ...
                Row(
                  children: const [
                    ...
                    Text("Pending", style: TextStyle(color: Colors.black, fontFamily: 'Shanti', fontSize: 16,)),
                  ],
                ),
                const SizedBox(
                  height: 7,
